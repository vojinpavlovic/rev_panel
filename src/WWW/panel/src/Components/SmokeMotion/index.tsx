...
const SmokeMotion = () => (
    <div className="fixed w-screen h-screen z-[-1]">
        <motion.img  
            ...
            animate={{y: [null, -30, -10, 0], x: [null, 100, -100, 0],scale: [null, 0.95, 1.05, 1.0]}}
